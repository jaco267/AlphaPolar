...
support_games=("amazons" "atari" "breakthrough" "clobber" "conhex" "connect6" "dotsandboxes" "go" "gomoku" "havannah" "hex" "kernsearch" "kernsearchtt" "killallgo" "linesofaction" "nogo" "othello" "puzzle2048" "rubiks" "santorini" "surakarta" "tictactoe")
