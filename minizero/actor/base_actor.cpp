...
void BaseActor::reset(){ //* almost done  called by zero_actor.reset()
    env_.reset(); action_info_history_.clear();  resetSearch();
}
void BaseActor::resetSearch(){ //* called by actor/zero_actor/resetSearch
