...
class BaseServer {
public:
    BaseServer(int port) : work_(io_service_),
    ...
    void startAccept(){
        //ConnectioonHandler is ZeroWorkerHandler in zero/zero_server
...
protected:
    void handleAccept(boost::shared_ptr<_ConnectionHandler> connection, 
