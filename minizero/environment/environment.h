...
typedef minizero::env::kernsearch::KernAction Action;
typedef minizero::env::kernsearch::KernEnv Environment;
typedef minizero::env::kernsearch::KernEnvLoader EnvironmentLoader;
#elif KERNSEARCHTT
#include "kernsearchtt.h"
typedef minizero::env::kernsearchtt::TicTacToeAction Action;
typedef minizero::env::kernsearchtt::TicTacToeEnv Environment;
typedef minizero::env::kernsearchtt::TicTacToeEnvLoader EnvironmentLoader;
...
inline void setUpEnv()
{
    ...
    config::env_board_size = 9;
#elif KERNSEARCH
    config::env_board_size = 12;    //todo   can be 4 or 16  
    config::learner_n_step_return = 10;
    // config::nn_num_hidden_channels = 512;
    // config::nn_num_value_hidden_channels = 512;
    // config::nn_num_blocks = 2;
    // config::zero_actor_intermediate_sequence_length = 10;
    // config::zero_num_games_per_iteration = 2;
    // config::learner_batch_size = 128;  //todo  original 1024  will out of memory for 16x16 kern
    // config::learner_training_step = 5000;
#elif KERNSEARCHTT
