...
void Network::loadModel(const std::string& nn_file_name, const int gpu_id){
    ...
    // cout<<"num_input_channels_"<<num_input_channels_<<endl
    //   <<"input_channel_height_"<<input_channel_height_<<endl
    //   <<"input_channel_width_"<<input_channel_width_<<endl
    //   <<"num_hidden_channels_"<<num_hidden_channels_<<endl
    //   <<"hidden_channel_height_"<<hidden_channel_height_<<endl
    //   <<"hidden_channel_width_"<<hidden_channel_width_<<endl
    //   <<"num_blocks_"<<num_blocks_<<endl
    //   <<"action_size_ "<<action_size_ <<endl
    //   <<"num_value_hidden_channels_"<<num_value_hidden_channels_<<endl
    //   <<"discrete_value_size_"<<discrete_value_size_<<endl
    //   <<"game_name_"<<game_name_<<endl
    //   <<"network type name  "<<network_type_name_<<endl;
}
